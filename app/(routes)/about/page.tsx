        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                I&apos;m Gan Hong Jian, Frontend Developer and Full Stack Agency with a passion for creating innovative web applications and exploring blockchain technologies. I&apos;m currently pursuing a Bachelor&apos;s in Computer Science at University of Malaya, where I continue to expand my knowledge and skills.
              </p>
              <p>
                With expertise in Next.js, React, and various frontend technologies, I enjoy building scalable and user-friendly applications that solve real-world problems. My background in computer science has given me a strong foundation in algorithms, data structures, and system design, which I apply to create efficient and maintainable code.
              </p>
              <p>
                So if you are interestend in my Frontend Development and Fullstack Agency, please contact me anyway. You can see my frontend development and fullstack angency work experience projects in my portfolio. I am always open to your interest and provide the most efficient remote work. Please check my portfolio carefully.
              </p>
            </div>
          ...
          >
            <h2 className="text-2xl font-bold mb-4">Full Stack Agency Skills</h2>
