...
export const skills: Record<SkillCategory, Skill[]> = {
  ...
  'Frontend Development': [
    { name: 'React.js', category: 'Frontend Development', logoKey: 'react' },
    { name: 'Next.js', category: 'Frontend Development', logoKey: 'nextjs' },
    { name: 'Tailwind CSS', category: 'Frontend Development', logoKey: 'tailwindcss' },
    { name: 'Three.js', category: 'Frontend Development', logoKey: 'threejs' },
    { name: 'Vue.js', category: 'Frontend Development', logoKey: 'vuejs' },
    { name: 'CMS Development', category: 'Frontend Development', logoKey: 'swift' },
  ],
};
